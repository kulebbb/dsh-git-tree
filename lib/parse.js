 ...
 * @param {string} output
 * @returns {Array<{hash: string, parents: string[], subject: string, author: string, date: string, refs: string[]}>}
 */
...
/**
 * Parse `git for-each-ref --format=%(refname)%x1f%(objectname)` output into
